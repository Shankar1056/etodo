...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, OnClickListener {
    ...
    private void domapping() {
        ...
        mEmailView.setTypeface(Utilz.font(LoginActivity.this, "medium"));
        mPasswordView.setTypeface(Utilz.font(LoginActivity.this, "medium"));
        sign_in.setTypeface(Utilz.font(LoginActivity.this, "bold"));
        gplus.setTypeface(Utilz.font(LoginActivity.this, "medium"));
        login_linkedin_btn.setTypeface(Utilz.font(LoginActivity.this, "medium"));
        fb.setTypeface(Utilz.font(LoginActivity.this, "medium"));
        noaccount.setTypeface(Utilz.font(LoginActivity.this, "medium"));
        sign_up.setTypeface(Utilz.font(LoginActivity.this, "medium"));
