...
public class SignupActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    private void domapping() {
        try {
            ...
            TextView gplus = (TextView)findViewById(R.id.gplus);
            ...
            username.setTypeface(Utilz.font(SignupActivity.this,"medium"));
            email.setTypeface(Utilz.font(SignupActivity.this,"medium"));
            password.setTypeface(Utilz.font(SignupActivity.this,"medium"));
            hideshowpassword.setTypeface(Utilz.font(SignupActivity.this,"medium"));
            registertext.setTypeface(Utilz.font(SignupActivity.this,"bold"));
            gplus.setTypeface(Utilz.font(SignupActivity.this,"medium"));
            login_linkedin_btn.setTypeface(Utilz.font(SignupActivity.this,"medium"));
            fb.setTypeface(Utilz.font(SignupActivity.this,"medium"));
            account.setTypeface(Utilz.font(SignupActivity.this,"medium"));
            login.setTypeface(Utilz.font(SignupActivity.this,"medium"));
