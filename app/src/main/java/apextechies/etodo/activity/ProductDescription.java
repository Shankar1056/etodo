...
public class ProductDescription extends AppCompatActivity implements View.OnClickListener {
	...
	private void domapping() {
		try {
			...
			vendorname.setTypeface(Utilz.font(ProductDescription.this,"bold"));
			phone.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			email.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			contactpersonname.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			location.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			websitelink.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			description.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			likecount.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			name.setTypeface(Utilz.font(ProductDescription.this,"bold"));
			sharetext.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			liketext.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			wishlisttext.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			rate.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			nametext.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			emailtext.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			contacttext.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			locationtext.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			websitetext.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			totalviews.setTypeface(Utilz.font(ProductDescription.this,"medium"));
			descriptiontext.setTypeface(Utilz.font(ProductDescription.this,"bold"));
			description.setTypeface(Utilz.font(ProductDescription.this,"medium"));
