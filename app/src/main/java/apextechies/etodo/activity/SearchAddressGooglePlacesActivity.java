...
import apextechies.etodo.LocationUtil.PlaceDetailsJSONParser;
import apextechies.etodo.LocationUtil.PlaceJSONParser;
...
import static apextechies.etodo.R.id.search_address_listview;


public class SearchAddressGooglePlacesActivity extends Activity implements LocationListener,AdapterView.OnItemClickListener {
	EditText atvPlaces;
	...
	//EA:76:1A:E6:61:56:40:CD:44:8A:4C:8E:03:49:02:19:B8:9A:4A:F1
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		searchAddressListview = (ListView) findViewById(search_address_listview);
		cureentlocationtv = (ImageButton) findViewById(R.id.cureentlocationtv);
		...
		final LinearLayout stateLayout = (LinearLayout)findViewById(R.id.stateLayout);
				...
				if (!response.equals("")) {
					...
					try {
						...
						if (success.equalsIgnoreCase("true")) {
							...
							homeGridAdapter = new StateGridAdapter(SearchAddressGooglePlacesActivity.this, homeCategories,
									SearchAddressGooglePlacesActivity.this);
