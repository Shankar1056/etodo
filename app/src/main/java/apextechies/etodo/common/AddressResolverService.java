...
/**
 * Created by Shankar on 9/8/2017.
 */
...
public class AddressResolverService extends IntentService {
    ...
    private void deliverResultToReceiver(int resultCode, String message, Address address) {
        try {
            ...
            bundle.putString(LOCATION_DATA_AREA, address.getSubLocality()+","+address.getLocality());

            //bundle.putString(LOCATION_DATA_CITY, address.getLocality());
            bundle.putString(LOCATION_DATA_CITY, address.getAddressLine(1));
